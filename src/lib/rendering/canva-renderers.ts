...
export namespace CanvaRenderers {
  export class Ellipse extends CanvaRenderer implements Renderer<CanvaRendererParameter>  {
  ...
  export class Rect extends CanvaRenderer implements Renderer<CanvaRendererParameter> {
    constructor(parameters: CanvaRendererParameter) {
      super(parameters);
    }
